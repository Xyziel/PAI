...
<div class="mainContainer">
    ...
    <div class="logoAndForm">
        ...
        <div class="form">
            <div class="text">
                <span class="createAccount">Stwórz konto</span>
            </div>
            <form action="?page=registration" method="POST">
                ...
                <span class="repeatPassword">Powtórz hasło:</span>
                <input name="repeatPassword" type="password" required>
                <button type="submit"><i class="fas fa-arrow-right"></i></button>
            </form>
            <span class="info">Posiadasz już konto? <a href="?page=login">Zaloguj się!</a></span>
        </div>
    </div>
